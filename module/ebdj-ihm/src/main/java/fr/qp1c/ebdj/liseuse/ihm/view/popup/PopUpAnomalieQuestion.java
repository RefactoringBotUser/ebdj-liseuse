...
public class PopUpAnomalieQuestion {
    ...
    private PopUpAnomalieQuestion() {
    }

    private static List<TypeAnomalie> listerTypeAnomalie(TypePartie typePartie) {
    ...
    public static SignalementAnomalie afficherPopUp(TypePartie typePartie) {
        ...
        listeTypeAnomalie.getItems().addAll(listerTypeAnomalie(typePartie));
