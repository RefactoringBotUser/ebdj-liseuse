...
import fr.qp1c.ebdj.liseuse.synchronisation.service.impl.SynchronisationServiceImpl;
...
public class PopUpSynchronisationQuestion {
	...
	private PopUpSynchronisationQuestion() {
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					barreProgressionSousPhase.setProgress(0.0);
					updateLibelleBarreProgressionPhase("Synchronisation des questions de 4ALS");
					...
					barreProgressionSousPhase.setProgress(0.0);
					updateLibelleBarreProgressionPhase("Synchronisation des questions de JD");
					...
					barreProgressionSousPhase.setProgress(0.0);
					updateLibelleBarreProgressionPhase("Synchronisation des questions de FAF");
					...
					barreProgressionPhase.setProgress(0.98);
					barreProgressionSousPhase.setProgress(0.0);
					updateLibelleBarreProgressionPhase("Finalisation de la synchronisation");
					updateLibelleBarreProgressionSousPhase("");

					SynchronisationService synchronisationService = new SynchronisationServiceImpl();
					synchronisationService.revelerStatut();
