...
public class QALSController implements PreferencesLecteur {
	...
	public void jouerNouveau4ALS() {
		...
		// Retrieving the observable list of the TextFlow Pane
		formaterContenuTheme4ALS(questionTheme4ALS1.getChildren(), theme4ALS_1);

		formaterContenuTheme4ALS(questionTheme4ALS2.getChildren(), theme4ALS_2);

		formaterContenuTheme4ALS(questionTheme4ALS3.getChildren(), theme4ALS_3);

		formaterContenuTheme4ALS(questionTheme4ALS4.getChildren(), theme4ALS_4);
	}
	...
	public void formaterContenuTheme4ALS(ObservableList<Node> list, Theme4ALS theme4ALS) {
		...
		Font fontS = Font.font("Venacti", FontWeight.BOLD, 18);
